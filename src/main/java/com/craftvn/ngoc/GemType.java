...
public enum GemType {
    ...
    SINH_MENH("&aNgọc Sinh Mệnh", "+2 thanh máu (tối đa 5p)", 50, Material.NETHERITE_BLOCK, 1, 120, false, 5),

    TANG_MAU("&cNgọc Tăng Máu", "Tăng 2 hàng máu trong 5 phút (xài 1 lần).", 20, Material.BEACON, 5, 30, false, 20),
    ...
    LONG_KINH("&eNgọc Lồng Kính", "Lồng kính to bằng kính thật trong 10s", 20, Material.IRON_BLOCK, 16, 60, true, 0),
    SAM_SET("&eNgọc Sấm Sét", "Gọi sét mục tiêu gần", 30, Material.DIAMOND, 2, 60, true, 0),
    DICH_CHUYEN("&eNgọc Dịch Chuyển", "TP ngẫu nhiên 7–10 block (an toàn)", 30, Material.DIAMOND_BLOCK, 1, 60, true, 0),
    CAM_BAY("&eNgọc Cạm Bẫy", "Dính tơ ngay + TP tới nạn nhân", 40, Material.NETHERITE_BLOCK, 1, 60, true, 0),
    TRUY_PHONG("&eNgọc Truy Phong", "Kéo người dùng/mặc Elytra về phía bạn", 50, Material.BEACON, 1, 60, true, 0),
